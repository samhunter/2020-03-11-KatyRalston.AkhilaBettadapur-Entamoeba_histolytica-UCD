...
```{r fragmentsPerSample, echo=FALSE, fig.height=3, fig.width=8, fig.align="center"}
library("gridExtra")
...
```{r saturationPlot1, echo=FALSE, fig.height=6, fig.width=12, fig.align="center"}
...
```{r saturationPlot2, echo=FALSE, fig.height=6, fig.width=12, fig.align="center"}
# Coerce data into "long" form.
...
```{r basecomposition, echo=FALSE, fig.height=5, fig.width=10, fig.align="center"}
...
```{r dinucleotideComposition, echo=FALSE, fig.height=5, fig.width=10, fig.align="center"}
...
```{r countHeatmap1, echo=FALSE, fig.height=16, fig.width=8, fig.align="center"}
library(pheatmap)
...
```{r fragmentsVreadsLogY, echo=FALSE, fig.height=6, fig.width=9, fig.align="center"}
...
```{r fragmentsVreadsLinearY, echo=FALSE, fig.height=6, fig.width=9, fig.align="center"}
ss2 = data.frame(sampleStats, mdata[match(sampleStats$sample, mdata$FileID), ])
ss2 = na.omit(ss2[ss2$Fragmented.gDNA != 'FC', ])
tmp = c("FC"="none", "FA"="Pilot", "FB"="Final")
ss2$Group = tmp[ss2$Fragmented.gDNA]
...
```{r insertsize, echo=FALSE, fig.height=4, fig.width=7, fig.align="center"}
library(tidyr)
samples = colnames(dtbnc)[5:ncol(dtbnc)]
...
```{r coverage, echo=FALSE, fig.height=7, fig.width=16, fig.align="center"}
library(karyoploteR)
...
```{r morecoverage, echo=FALSE, fig.height=7, fig.width=16, fig.align="center"}
...
```{r morecoverage2, echo=FALSE, fig.height=7, fig.width=16, fig.align="center"}
